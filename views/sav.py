...
df_log_adcq = pd.read_csv('static/df_one_sav.csv', delimiter=',', header=0)
data_df_log_adcq = [
    go.Scatter(
        x=df_log_adcq['_2'],
        y=df_log_adcq['_1']
...
df_second_log_adcq = pd.read_csv('static/df_second_sav.csv', delimiter=',', header=0)
data_df_second_log_adcq = [
    go.Scatter(
        x=df_second_log_adcq['_2'],
        y=df_second_log_adcq['_1']
    )
]

df_log_adcq_count = pd.read_csv('static/df_log_adcq_count_sav.csv', delimiter=',', header=0)
